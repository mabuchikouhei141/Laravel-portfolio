                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.skills.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="range" name="level" id="level" min="0" max="100" value="{{ old('level', 50) }}" class="mt-1 block w-full" oninput="levelOutput.value = level.value">
                            <output id="levelOutput" class="mt-1 block">50</output>
                            @error('level')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
