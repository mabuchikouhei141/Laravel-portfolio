        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-12">
            <div class="md:flex">
                ...
                <div class="p-8 md:w-2/3">
                    ...
                    <h1 class="mt-2 text-3xl font-bold text-gray-900">あなたの名前</h1>
                    <p class="mt-2 text-xl text-gray-600">ウェブ開発者 / デザイナー</p>
                    
                    <div class="mt-6 text-gray-700">
                        <p class="mb-4">
                            ここにあなたの自己紹介文を記載します。専門分野、経験年数、得意なこと、情熱を持っていることなどを書きましょう。
                        </p>
                        <p>
            ...
            <div class="space-y-8">
                @forelse($education as $edu)
                    <div class="relative">
                        ...
                        <div class="relative flex items-start">
                            <div class="flex items-center justify-center h-10 w-10 rounded-full bg-green-500 text-white shrink-0 mr-4">
                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div>
                                ...
                                @if($edu->degree)
                                    <p class="text-gray-600">{{ $edu->degree }}@if($edu->field_of_study) - {{ $edu->field_of_study }}@endif</p>
                                @endif
                                <p class="text-sm text-gray-500">
